...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
      <h1 class="text-center"><font color="white" size="7" face="Algerian">Elecciones 2021 Foco Rojo</font></h1>
    </div>
  </div>
  <br>
</div>
 <div class="center-block col-md-4 col-xs-8">
		<td>
<?php
echo "<center><font size='6' color='white' face='Algerian'>Bienvenido </font>"."<center><font size='6' face='Algerian' color='white'>".$_SESSION["nombre"]."</font></center>";
                            ...
                            for ($i=0;$i<$num_reg;$i++) {
                                ...
                                echo '
																<div style="margin: 1rem;">
																	...
																	<span>'.$nombre.'</span>
																	<input type="radio" name="municipios" value="'.$codigomun.'" />
																</div>
																';
                            }
?>
